...
func (x *Address) Reset() {
	*x = Address{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shop_v1_address_proto_msgTypes[0]
...
func (*Address) Descriptor() ([]byte, []int) {
	return file_shop_v1_address_proto_rawDescGZIP(), []int{0}
}
...
func (x *Address_Customer) Reset() {
	*x = Address_Customer{}
	if protoimpl.UnsafeEnabled {
		mi := &file_shop_v1_address_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Address_Customer) Descriptor() ([]byte, []int) {
	return file_shop_v1_address_proto_rawDescGZIP(), []int{0, 0}
}
...
var File_shop_v1_address_proto protoreflect.FileDescriptor

var file_shop_v1_address_proto_rawDesc = []byte{
	0x0a, 0x15, 0x73, 0x68, 0x6f, 0x70, 0x2f, 0x76, 0x31, 0x2f, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73,
	0x73, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x07, 0x73, 0x68, 0x6f, 0x70, 0x2e, 0x76, 0x31,
	...
	0x2e, 0x76, 0x31, 0x2e, 0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x2e, 0x43, 0x75, 0x73, 0x74,
	...
	0x52, 0x0c, 0x63, 0x75, 0x73, 0x74, 0x6f, 0x6d, 0x65, 0x72, 0x54, 0x79, 0x70, 0x65, 0x42, 0x92,
	0x01, 0x0a, 0x0b, 0x63, 0x6f, 0x6d, 0x2e, 0x73, 0x68, 0x6f, 0x70, 0x2e, 0x76, 0x31, 0x42, 0x0c,
	0x41, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x38,
...
var (
	file_shop_v1_address_proto_rawDescOnce sync.Once
	file_shop_v1_address_proto_rawDescData = file_shop_v1_address_proto_rawDesc
)

func file_shop_v1_address_proto_rawDescGZIP() []byte {
	file_shop_v1_address_proto_rawDescOnce.Do(func() {
		file_shop_v1_address_proto_rawDescData = protoimpl.X.CompressGZIP(file_shop_v1_address_proto_rawDescData)
	})
	return file_shop_v1_address_proto_rawDescData
}

var file_shop_v1_address_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
var file_shop_v1_address_proto_goTypes = []interface{}{
	(*Address)(nil),               // 0: shop.v1.Address
	(*Address_Customer)(nil),      // 1: shop.v1.Address.Customer
	(*timestamppb.Timestamp)(nil), // 2: google.protobuf.Timestamp
}
var file_shop_v1_address_proto_depIdxs = []int32{
	1, // 0: shop.v1.Address.customer:type_name -> shop.v1.Address.Customer
	2, // 1: shop.v1.Address.created_at:type_name -> google.protobuf.Timestamp
...
func init() { file_shop_v1_address_proto_init() }
func file_shop_v1_address_proto_init() {
	if File_shop_v1_address_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_shop_v1_address_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_shop_v1_address_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_shop_v1_address_proto_rawDesc,
			NumEnums:      0,
			NumMessages:   2,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_shop_v1_address_proto_goTypes,
		DependencyIndexes: file_shop_v1_address_proto_depIdxs,
		MessageInfos:      file_shop_v1_address_proto_msgTypes,
	}.Build()
	File_shop_v1_address_proto = out.File
	file_shop_v1_address_proto_rawDesc = nil
	file_shop_v1_address_proto_goTypes = nil
	file_shop_v1_address_proto_depIdxs = nil
}
